...
interface CGAssetApplyDownloadBoxDeliverViewAdminProps {
...
export const CGAssetApplyDownloadBoxDeliverViewAdmin: React.FC<CGAssetApplyDownloadBoxDeliverViewAdminProps> = ({
  initialData,
  cgAsset,
  manageUsers,
  setDialogOpen,
  ...
  const form = useForm<any>({
    resolver: zodResolver(ApplyDownloadBoxDeliverViewAdminSchema),
    defaultValues
  });
...
export default CGAssetApplyDownloadBoxDeliverViewAdmin
