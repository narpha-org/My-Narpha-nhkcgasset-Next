...
interface AssetInfoApprovalListEditorProps {
...
const AssetInfoApprovalListEditor: React.FC<AssetInfoApprovalListEditorProps> = forwardRef(({
  searchRef,
  approvals,
  approvalsPg
}) => {
  ...
  const fetchData = async (param) => {
    ...
    setItems(() => ret.data.ApplyDownloadsApplyOrApproval.data);
    setPgInfo(() => ret.data.ApplyDownloadsApplyOrApproval.paginatorInfo);
...
AssetInfoApprovalListEditor.displayName = "AssetInfoApprovalListEditor";

export default AssetInfoApprovalListEditor