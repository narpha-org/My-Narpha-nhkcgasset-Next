...
const AssetInfoApprovalListManager: React.FC<AssetInfoApprovalListManagerProps> = forwardRef(({
  searchRef,
  approvals,
  approvalsPg
}) => {
...
AssetInfoApprovalListManager.displayName = "AssetInfoApprovalListManager";
