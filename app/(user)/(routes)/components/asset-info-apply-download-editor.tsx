...
interface AssetInfoApplyDownloadEditorProps {
...
const AssetInfoApplyDownloadEditor: React.FC<AssetInfoApplyDownloadEditorProps> = forwardRef(({
  searchRef,
  downloadApplies,
  downloadAppliesPg,
}) => {
    ...
    const ret: ApolloQueryResult<{
      ...
      .query({
        ...
        variables: {
          ...
          section_adl: 'ADL_EDITOR',
          searchTxt: param.searchTxt, // searchTxt
        }
      });
    setItems(() => ret.data.ApplyDownloadsNotDone.data);
    setPgInfo(() => ret.data.ApplyDownloadsNotDone.paginatorInfo);
...
AssetInfoApplyDownloadEditor.displayName = "AssetInfoApplyDownloadEditor";

export default AssetInfoApplyDownloadEditor