...
export const TemplateDetailClient: React.FC<TemplateDetailClientProps> = ({ }) => {
          ...
          <div className="detail__inner">
            <div className="detail__mainbox">
              ...
              <div className="detail__mainimg">
                <a href="">
                  <Image src="/assets/images/detail_mainimg.jpg" width={753.75} height={425.47} alt="" />
                </a>
                <div className="detail__listbox">
                  <ul>
                    <li><a href="" className="active"><Image src="/assets/images/detail_tumb.jpg"
                      decoding="async" width={66.29} height={37.71} alt="" />
                    </a></li>
                    <li><a href=""><Image src="/assets/images/detail_tumb.jpg"
                      decoding="async" width={66.29} height={37.71} alt="" />
                    </a></li>
                    <li><a href=""><Image src="/assets/images/detail_tumb.jpg"
                      decoding="async" width={66.29} height={37.71} alt="" />
