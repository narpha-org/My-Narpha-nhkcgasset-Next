...
export const CGaBroadcastingRightForm: React.FC<CGaBroadcastingRightFormProps> = ({
  ...
  const onSubmit = async (data: CGaBroadcastingRightFormValues) => {
    try {
      ...
      router.refresh();
      router.push(`/c_g_a_broadcasting_rights`);
    ...
    <>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 w-full">
          ...
          <Button disabled={loading} className="ml-auto mr-2" variant="outline" type="button" onClick={() => router.push(`/c_g_a_broadcasting_rights`)}>
            キャンセル
          </Button>
