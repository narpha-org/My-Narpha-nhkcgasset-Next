...
export const ApplyDownloadDlNoticeViewManagerSchema = z.object({
...
export type ApplyDownloadDlNoticeViewManagerValues = z.infer<typeof ApplyDownloadDlNoticeViewManagerSchema>

interface CGAssetApplyDownloadDlNoticeViewManagerProps {
...
export const CGAssetApplyDownloadDlNoticeViewManager: React.FC<CGAssetApplyDownloadDlNoticeViewManagerProps> = ({
  initialData,
  cgAsset,
  manageUsers,
  setDialogOpen,
  ...
  const form = useForm<any>({
    resolver: zodResolver(ApplyDownloadDlNoticeViewManagerSchema),
    defaultValues
  });
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <Heading title="ダウンロード済み" description={`アセットID: ${cgAsset?.asset_id} のダウンロード済み内容`} />
      </div>
      {/* <Separator /> */}
      <Form {...form}>
...
export default CGAssetApplyDownloadDlNoticeViewManager
