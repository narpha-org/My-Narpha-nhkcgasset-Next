...
export const ApplyDownloadBoxDeliverViewManagerSchema = z.object({
...
export type ApplyDownloadBoxDeliverViewManagerValues = z.infer<typeof ApplyDownloadBoxDeliverViewManagerSchema>

interface CGAssetApplyDownloadBoxDeliverViewManagerProps {
...
export const CGAssetApplyDownloadBoxDeliverViewManager: React.FC<CGAssetApplyDownloadBoxDeliverViewManagerProps> = ({
  initialData,
  cgAsset,
  manageUsers,
  setDialogOpen,
  ...
  const form = useForm<any>({
    resolver: zodResolver(ApplyDownloadBoxDeliverViewManagerSchema),
    defaultValues
  });
...
export default CGAssetApplyDownloadBoxDeliverViewManager
