...
interface CGAssetApplyDownloadApplyViewProps {
...
export const CGAssetApplyDownloadApplyView: React.FC<CGAssetApplyDownloadApplyViewProps> = ({
  initialData,
  cgAsset,
  manageUsers,
  setDialogOpen,
...
export default CGAssetApplyDownloadApplyView
