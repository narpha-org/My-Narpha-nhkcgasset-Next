...
export type ApplyDownloadRemovalViewValues = z.infer<typeof ApplyDownloadRemovalViewSchema>

interface CGAssetApplyDownloadRemovalViewProps {
...
export const CGAssetApplyDownloadRemovalView: React.FC<CGAssetApplyDownloadRemovalViewProps> = ({
  initialData,
  cgAsset,
  manageUsers,
  setDialogOpen,
  ...
  const form = useForm<any>({
    resolver: zodResolver(ApplyDownloadRemovalViewSchema),
    defaultValues
  });
...
export default CGAssetApplyDownloadRemovalView
