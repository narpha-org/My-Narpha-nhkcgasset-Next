...
interface CGAssetApplyDownloadGlacierFormConfirmProps {
...
export const CGAssetApplyDownloadGlacierFormConfirm: React.FC<CGAssetApplyDownloadGlacierFormConfirmProps> = ({
  form,
  initialData,
  cgAsset,
  manageUsers,
...
export default CGAssetApplyDownloadGlacierFormConfirm