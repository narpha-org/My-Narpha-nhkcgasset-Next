...
export type ApplyDownloadApprovalViewValues = z.infer<typeof ApplyDownloadApprovalViewSchema>

interface CGAssetApplyDownloadApprovalViewProps {
...
export const CGAssetApplyDownloadApprovalView: React.FC<CGAssetApplyDownloadApprovalViewProps> = ({
  initialData,
  cgAsset,
  manageUsers,
  setDialogOpen,
  ...
  const form = useForm<any>({
    resolver: zodResolver(ApplyDownloadApprovalViewSchema),
    defaultValues
  });
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <Heading title="ダウンロード承認済み" description={`アセットID: ${cgAsset?.asset_id} のダウンロード承認内容`} />
      </div>
      {/* <Separator /> */}
      <Form {...form}>
        <form className="space-y-8 w-full">
          <div className="maincon">
            <div className="applypage flex flex-row space-x-4">
              ...
              <div className="basis-1/3">
                <div className="flex flex-col space-y-4">
                  ...
                  {(form.getValues('download_date') || form.getValues('removal_limit_date')) &&
                    <div className="applypage__info rounded-lg border-2 border-slate-400/50 p-6">
            ...
            /> */}
                        ...
                        {form.getValues('removal_limit_date') &&
                          <li>
                            <FormField
                              control={form.control}
...
export default CGAssetApplyDownloadApprovalView
