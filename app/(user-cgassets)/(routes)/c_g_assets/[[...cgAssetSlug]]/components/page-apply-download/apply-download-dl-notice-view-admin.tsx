...
export const ApplyDownloadDlNoticeViewAdminSchema = z.object({
...
export type ApplyDownloadDlNoticeViewAdminValues = z.infer<typeof ApplyDownloadDlNoticeViewAdminSchema>

interface CGAssetApplyDownloadDlNoticeViewAdminProps {
...
export const CGAssetApplyDownloadDlNoticeViewAdmin: React.FC<CGAssetApplyDownloadDlNoticeViewAdminProps> = ({
  initialData,
  cgAsset,
  manageUsers,
  setDialogOpen,
  ...
  const form = useForm<any>({
    resolver: zodResolver(ApplyDownloadDlNoticeViewAdminSchema),
    defaultValues
  });
...
export default CGAssetApplyDownloadDlNoticeViewAdmin
