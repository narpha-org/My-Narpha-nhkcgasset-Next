...
export const CGAssetApplyDownloadRemovalFormInput: React.FC<CGAssetApplyDownloadRemovalFormInputProps> = ({
  form,
  initialData,
  cgAsset,
  manageUsers,
...
export default CGAssetApplyDownloadRemovalFormInput
