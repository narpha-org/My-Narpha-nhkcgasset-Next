...
interface CGAssetApplyDownloadGlacierFormInputProps {
...
export const CGAssetApplyDownloadGlacierFormInput: React.FC<CGAssetApplyDownloadGlacierFormInputProps> = ({
  form,
  initialData,
  cgAsset,
  manageUsers,
...
export default CGAssetApplyDownloadGlacierFormInput