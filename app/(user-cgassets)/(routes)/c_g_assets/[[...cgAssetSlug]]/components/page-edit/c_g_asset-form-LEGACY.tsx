...
import ImageUpload, { UploadImageProps, UploadThumbProps } from "@/components/ui/image-upload"
...
export const CGAssetForm: React.FC<CGAssetFormProps> = ({
  ...
  const defaultValues = initialData ? {
    ...
    assetUploads: initialData?.assetUploads as UploadOnlyFileProps[],
    assetThumbs: initialData?.assetThumbs as UploadThumbProps[],
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input disabled={loading} placeholder="都市、ビル" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
