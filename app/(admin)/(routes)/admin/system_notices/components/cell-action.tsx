...
import {
  DeleteSystemNoticeDocument, SystemNotice,
...
import { SystemNoticeColumn } from "./columns";
...
export const CellAction: React.FC<CellActionProps> = ({
  ...
  const onCopy = (id: string) => {
    ...
    toast.success('お知らせのIDがクリップボードにコピーされました。');
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => router.push(`/admin/system_notices/${data.id}`)}
          >
