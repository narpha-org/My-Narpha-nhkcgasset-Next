...
import { CGAssetUploadDirColumn } from "./columns";
...
export const CellAction: React.FC<CellActionProps> = ({
  ...
  const onConfirm = async () => {
    try {
      ...
      toast.error('削除できません。このアップロード場所を使用中のCGアセット情報が存在します。');
    } finally {
      setOpen(false);
      setLoading(false);
    }
  ...
  const onCopy = (id: string) => {
    ...
    toast.success('アップロード場所のIDがクリップボードにコピーされました。');
  }
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => router.push(`/admin/c_g_asset_upload_dirs/${data.id}`)}
          >
