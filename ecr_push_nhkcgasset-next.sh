...
docker tag nhkcgasset-next:"${GIT_COMMIT_ID}" 735641424488.dkr.ecr.ap-northeast-1.amazonaws.com/nhkcgasset-next:"${GIT_COMMIT_ID}"
docker push 735641424488.dkr.ecr.ap-northeast-1.amazonaws.com/nhkcgasset-next:"${GIT_COMMIT_ID}"
